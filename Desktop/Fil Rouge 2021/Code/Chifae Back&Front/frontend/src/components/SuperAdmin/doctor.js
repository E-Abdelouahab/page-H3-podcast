...
// get all admin and show it in table
  ...
  const deletedoctor = (id)=>{
    var msgConfirmation = window.confirm("Are You Sure Yo want to delete this Admin ?");
    if (msgConfirmation) {
    axios.delete(`http://localhost:3030/superAdmin/deletedoctor/${id}`)
    .then(function (response) {
...
<div className="overflow-x-auto" style={{width:1200}}>
  ...
  <div className=" flex items-center justify-center font-sans " style={{marginTop:150,marginLeft:250}}>
    ...
    <Link to='/adddoctor' class="bg-blue-300 hover:bg-green-100 text-black font-bold py-2 px-4 rounded-md">Add Doctor</Link>
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-100">
              ...
              <td className="py-3 px-6 text-center">
                ...
                <div className="flex item-center justify-center">               
                  <Link onClick={()=>getIddoctor(item._id)} className="w-4 mr-2 transform hover:text-yellow-500 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                  </Link>
                  <Link onClick={()=>deletedoctor(item._id)} className="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
