...
const  Addevent = () => {
    ...
    const id=localStorage.getItem('assSec');     
...
//---------add Product------------- 
    ...
    const event = {titel,description,productImg,category,idassSec:IdassSec,status,id};

	axios.post(`http://localhost:3030/Seller/addevent`,event)
