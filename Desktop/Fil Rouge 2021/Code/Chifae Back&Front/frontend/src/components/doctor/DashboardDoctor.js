...
useEffect( () => {
  ...
  axios.get(`http://localhost:3030/doctor/getAlldelegation`)
    .then(function (response) {
      ...
      setdelegation(response.data.length)
    }).catch(function (err) {
      console.log(err);
  });
  ...
  // get all Intiative Man and show it in table
  ...
  <div className="flex flex-wrap -m-4 text-center">
    ...
    <div className="p-4 md:w-2/4 sm:w-1/2 w-full">
      <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
        ...
        <h2 className="title-font font-medium text-3xl text-black">{intiativeLength}</h2>
        <p className="leading-relaxed">intiative</p>
      </div>
    </div>
    <div className="p-4 md:w-2/4 sm:w-1/2 w-full">
      <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
        ...
        <h2 className="title-font font-medium text-3xl text-black">{delegation}</h2>
        <p className="leading-relaxed ">Delegation</p>
      </div>
    </div>
