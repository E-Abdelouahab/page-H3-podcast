        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
              <nav class="navbar navbar-light bg-faded">
                <span class="navbar-brand" style="color: chocolate;"><a href="/" style="text-decoration: none; color:chocolate;">Product</a></span>
                  </nav>
                     <div class="col s12" style="margin-top: 3%;">
                            ...
                            <thead>
                                <tr>
                                  <th style="width: 15%;text-align: center;">ID</th>
                                    <th style="width: 15%;text-align: center;">PRODUCT CATEGORY</th>
                                    <th style="width: 15%;text-align: center;">PRODUCT TITLE</th>
                                    <th style="width: 15%;text-align: center;">PRODUCT PRICE</th>
                                    <th style="width: 15%;text-align: center;">PRODUCT DESCRIPTION</th>
                                    <th style="width: 15%;text-align: center;">PRODUCT PICTURE</th>
                            ...
                            echo '<tr> 
                            <td style="width: 15%;text-align: center;"><a style="color: chocolate; text-decoration: none;">' . $row["product_id"] . '</a></td>
                            <td style="width: 15%;text-align: center;">' . $row["product_cat"] . '</td>
                            <td style="width: 15%;text-align: center;">' . $row["product_title"] . ' </td>
                            <td style="width: 15%;text-align: center;">' . $row["product_price"] . '</td>
                            <td style="width: 15%;text-align: center;">' . $row["product_desc"] . '</td>
                            <th style="width: 15%;text-align: center;"><img style="width: 80px;" src="../assets/product_images/' . $row["product_image"] . '" alt="hyhhhhh"> </th>
                            <td solspan="2" style="width: 20%;text-align: center;">
                              <a href="update.php?id=' . $row["product_id"] . ' button type="submit" name="btn_edit" data-toggle="modal" data-target="" class="btn btn-success btn-sm btn-circle btnedit">
                                Edit
                            </button>
                    ...
                    <div class="col s12" style="margin-top: 3%;">
                        <a href="" class="btn btn-outline-success">Add new produit</a>
                    </div>
                     </div><!--/col-12-->
                </div>
              </div>   
...
<!-- footer -->
            ...
            <footer class="footer text-center">
                All Rights Reserved by Artisa-Tour2020 Designed and Developed by <a href="">abdel-dev</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
</html>